...
func TestEqualItems(t *testing.T) {
	tests := []struct {
		...
		{
			name: "same Maximum",
			a:    &Items{Maximum: testutil.Ptr(100.0)},
			b:    &Items{Maximum: testutil.Ptr(100.0)},
			want: true,
		},
		{
			name: "different Maximum",
			a:    &Items{Maximum: testutil.Ptr(100.0)},
			b:    &Items{Maximum: testutil.Ptr(200.0)},
			want: false,
		},
		{
		...
		{
			name: "same Minimum",
			a:    &Items{Minimum: testutil.Ptr(0.0)},
			b:    &Items{Minimum: testutil.Ptr(0.0)},
			want: true,
		},
		{
			name: "different Minimum",
			a:    &Items{Minimum: testutil.Ptr(0.0)},
			b:    &Items{Minimum: testutil.Ptr(1.0)},
			want: false,
		},
		{
		...
		},
		{
			...
			a:    &Items{MultipleOf: testutil.Ptr(5.0)},
			b:    &Items{MultipleOf: testutil.Ptr(5.0)},
			want: true,
		},
		{
			name: "different MultipleOf",
			a:    &Items{MultipleOf: testutil.Ptr(5.0)},
			b:    &Items{MultipleOf: testutil.Ptr(10.0)},
			want: false,
		},
		{
		...
		{
			name: "same MaxLength",
			a:    &Items{MaxLength: testutil.Ptr(100)},
			b:    &Items{MaxLength: testutil.Ptr(100)},
			want: true,
		},
		{
			name: "different MaxLength",
			a:    &Items{MaxLength: testutil.Ptr(100)},
			b:    &Items{MaxLength: testutil.Ptr(200)},
			want: false,
		},
		{
		...
		{
			name: "same MinLength",
			a:    &Items{MinLength: testutil.Ptr(1)},
			b:    &Items{MinLength: testutil.Ptr(1)},
			want: true,
		},
		{
			name: "different MinLength",
			a:    &Items{MinLength: testutil.Ptr(1)},
			b:    &Items{MinLength: testutil.Ptr(5)},
			want: false,
		},
		{
		...
		{
			name: "same MaxItems",
			a:    &Items{MaxItems: testutil.Ptr(10)},
			b:    &Items{MaxItems: testutil.Ptr(10)},
			want: true,
		},
		{
			name: "different MaxItems",
			a:    &Items{MaxItems: testutil.Ptr(10)},
			b:    &Items{MaxItems: testutil.Ptr(20)},
			want: false,
		},
		{
		...
		{
			name: "same MinItems",
			a:    &Items{MinItems: testutil.Ptr(1)},
			b:    &Items{MinItems: testutil.Ptr(1)},
			want: true,
		},
		{
			name: "different MinItems",
			a:    &Items{MinItems: testutil.Ptr(1)},
			b:    &Items{MinItems: testutil.Ptr(2)},
			want: false,
		},
		{
