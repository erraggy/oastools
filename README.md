...
The [`examples/`](examples/) directory contains complete, working examples generated by oastools.

| Example | Description |
|---------|-------------|
| [petstore](examples/petstore/) | Full client/server with OAuth2, OIDC, credential management, and all server extensions |

Each example is a standalone Go module you can browse, copy, or reference. See [`examples/README.md`](examples/README.md) for details.
