...
func (cg *oas3CodeGenerator) generateClient() error {
	...
	needsTime := cg.clientNeedsTimeImport()
...
// clientNeedsTimeImport checks if any operation parameters or responses use time.Time
func (cg *oas3CodeGenerator) clientNeedsTimeImport() bool {
	if cg.doc.Paths == nil {
		return false
	}
